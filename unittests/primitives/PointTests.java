...
public class PointTests {
    ...
    void testAdd() {
        ...
        assertEquals(p1.add(new Vector(1.0, 2.0, 3.0)), new Point(2.0, 4.0, 6.0), "add doesn't work properly");

        // =============== Boundary Values Tests ==================
        //TC02: test adding a point to a vector and creating a 0 point
        assertEquals(p1.add(new Vector(-1.0, -2.0, -3.0)), new Point(0.0, 0.0, 0.0), "add doesn't work properly");
    ...
    void testSubtract() {
        ...
        assertEquals(p1.subtract(p2), new Vector(-1.0, 4.0, 3), "subtract doesn't work properly");
    ...
    void testDistanceSquared() {
        ...
        assertEquals(0, p1.distanceSquared(p1), "distanceSquared doesn't work properly");
    }
    ...
    void distance() {
        ...
        assertEquals(0, p1.distance(p1), "distance doesn't work properly");
    }
}