...
public class SoftShadowTest {
    ...
    void MiniProject_1() {
        ...
        Camera camera = new Camera(new Point(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
                ...
                .setRayTracer(new RayTracerBasic(scene).setNumberOfPoints(1000));
    ...
    void test() {
        ...
        scene.geometries.add(
                ...
                //Lamp
                new Sphere(new Point(40, 100, -100), 15).setMaterial(new Material().setKs(0.3).setKd(0.5).setShininess(20).setKt(0.1))
                        .setEmission(new Color(GRAY)),
                new Sphere(new Point(40, 50, -100), 20).setMaterial(ball).setEmission(new Color(BLUE))
        );
